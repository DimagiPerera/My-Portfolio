            ...
            <div className="sideNavbar1">
              <ul className="sidebar d__flex">
                <li className="sideNavbar">
                  <a className="sideNavbarLinks" href="#Home">Home</a>
                </li>
                <li className="sideNavbar">
                  <a className="sideNavbarLinks" href="#About">About</a>
                </li>
                <li className="sideNavbar">
                  <a className="sideNavbarLinks" href="#Services">Services</a>
                </li>
                <li className="sideNavbar">
                  <a className="sideNavbarLinks" href="#Portfolio">Projects</a>

                  </li>

                  <li className="sideNavbar">
                  <a className="sideNavbarLinks" href="#Skills">Skills</a>

                  </li>

                <li className="sideNavbar">
                  <a className="sideNavbarLinks" href="#Blog">Upcoming</a>
                </li>
                <li className="sideNavbar">
                  <a className="sideNavbarLinks" href="#Contact">Contact</a>
                </li>
              </ul>
            </div>
          ) : null}
        ...
        <div className="container">
          <div className="home__content">
            <div className="home__meta">
              ...
              <h2 className="home__text pz__10">I’m Dimagi Perera</h2>
              ...
              <a href="mailto:dimaginipunika@gmail.com"><img style={{marginLeft:20}} src={logo1} alt="" className="logo1" /></a>
            </div>
          </div>
        </div>
      </div>
